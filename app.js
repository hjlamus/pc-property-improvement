...
const translations = {
    en: {
        ...
        "hero-desc": "From painting and drywall to full framing and handyman services. We deliver high-quality craftsmanship for apartment complexes, general contractors, and residential owners in Atlanta.",
        ...
        "srv-drywall-title": "Sheetrock Installation & Finishing",
        "srv-drywall-desc": "Installation of drywall on walls and ceilings, baseboards, trim, and interior and exterior doors.",
        "srv-framer-title": "Wood Framing",
        "srv-framer-desc": "Framing for new construction, home additions, garages, sheds, and attic finishing.",
        "srv-fences-title": "Fences & Gates",
        "srv-fences-desc": "Installation and repair of wood, vinyl, and metal fences and gates for security and property boundaries.",
        "srv-deck-title": "Decks & Outdoor Structures",
        "srv-deck-desc": "Custom deck design and construction, railing installation, structural wood repairs, and wood staining and sealing.",
        "srv-trash-title": "Trash-Out & Cleanout Services",
        "srv-trash-desc": "Fast property cleanouts, junk removal, garage cleanouts, and post-eviction cleanups.",
        "srv-plumbing-title": "Plumbing Services",
        "srv-plumbing-desc": "Leak repairs, toilet, sink and faucet installation, drain cleaning, and pipe repair and maintenance.",
        "srv-tiles-title": "Tile Installation",
        "srv-tiles-desc": "Floor tile installation, bathroom and shower tile, kitchen backsplashes, tile repairs, and tile replacement.",
        "srv-floor-title": "Flooring Installation",
        "srv-floor-desc": "Laminate, LVP (Luxury Vinyl Plank), hardwood flooring installation, and floor repair and replacement.",
        "srv-washing-title": "Pressure Washing",
        "srv-washing-desc": "Driveways, sidewalks, patios, decks, house exteriors, and commercial property pressure washing.",
        "srv-cabinet-title": "Cabinet Services",
        "srv-cabinet-desc": "Cabinet installation, cabinet painting, cabinet repairs, and hardware replacement (handles and knobs).",
        "srv-roof-title": "Roofing Services",
        "srv-roof-desc": "Roof leak repairs, shingle repair and replacement, interior ceiling drywall repair from water damage, storm damage repairs, and general roof maintenance.",
    ...
    es: {
        ...
        "hero-desc": "Desde pintura y drywall hasta estructuras de madera y servicios de reparación y mantenimiento. Entregamos acabados premium para administradores de edificios, contratistas y dueños de casas en Atlanta.",
        ...
        "srv-drywall-title": "Drywall y Techos (Sheetrock)",
        "srv-drywall-desc": "Instalación de paneles de drywall en paredes y techos, instalación de zócalos, molduras y puertas interiores y exteriores.",
        ...
        "srv-deck-desc": "Diseño y construcción de decks, instalación de barandales (barandillas), reparación de estructuras de madera, mantenimiento y aplicación de tinte o sellador para proteger la madera.",
        ...
        "srv-plumbing-title": "Plomería",
        "srv-plumbing-desc": "Reparación de fugas de agua, instalación y cambio de inodoros, lavamanos, grifos (llaves de agua), destape de desagües y mantenimiento de tuberías.",
        "srv-tiles-title": "Pisos y Cerámicas (Tile)",
        "srv-tiles-desc": "Instalación de pisos de cerámica y porcelanato, revestimiento de baños, duchas, paredes y salpicaderos de cocina (backsplash), además de reparación y reemplazo de losetas.",
        "srv-floor-title": "Instalación de Pisos (Flooring)",
        "srv-floor-desc": "Instalación de pisos laminados, LVP (Luxury Vinyl Plank), madera (hardwood) y reemplazo o reparación de pisos.",
        "srv-washing-title": "Lavado a Presión (Pressure Washing)",
        "srv-washing-desc": "Lavado de entradas de vehículos (driveways), aceras, patios, decks, paredes exteriores de la casa y áreas comerciales.",
        ...
        "srv-roof-title": "Techos y Reparaciones (Roofing)",
        "srv-roof-desc": "Reparación de goteras, cambio y reparación de shingles (tejas asfálticas), reparación de cielos interiores (drywall de techos) dañados por filtraciones, daños por tormentas y mantenimiento general del techo.",
